      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <a href="{{route('user.impression_taches')}}" class="btn btn-primary"><i class="bi bi-printer-fill"></i></a>
              ...
              <tbody>
                @foreach($tachesAll as $taches)
                  <tr>
                    ...
                    @endif
                    @if(Illuminate\Support\Facades\Auth::user()->user_role=='ADMIN')
                    <td><a class="btn btn-dark" href="{{route('update.taches.view',['id'=>$taches->id])}}"><i class="bi bi-pencil"></i></a></td>
                    @endif
                  </tr>
                @endforeach
              </tbody>
